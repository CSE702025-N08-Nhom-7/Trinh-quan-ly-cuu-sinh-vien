...
<title>News Navigation Bar</title>
</head>
...
<ul class="ul1">
    ...
    <div class="dropdown">
  	<li class="li1 active"><a href="news.php"><span class="span1">News</span></a></li>
    	<div class="dropdown-content">
...
<button id="news_totop" onclick="topFunction()"><img src="image/top.jpg" width="50px" height="50px"/></button>
<script src="javascript/news_totop.js"></script>
