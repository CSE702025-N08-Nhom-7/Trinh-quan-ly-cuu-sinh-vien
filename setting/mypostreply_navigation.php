...
<body>
<div>
<img src="image\headimg2.jpg" width="100%" height="250px" />
</div>
<table class="table">
<tr>
<td>
<ul class="ul1">
	<div class="dropdown">
	<li class="li_image"><img src="image\logo2.jpg" width="55px" height="55px" style="padding-left:15px;padding-right:15px" /></li>
    </div>
    <div class="dropdown">
    ...
    <div class="dropdown">
    <li class="li1"><a href="alumni_financial.php"><span class="span1">Financial Record</span></a></li>
...
<button id="alumnipostreply_totop" onclick="topFunction()"><img src="image/top.jpg" width="50px" height="50px"/></button>
<script src="javascript/alumnipostreply_totop.js"></script>
</body>
</html>