...
<button id="deletepost_totop" onclick="topFunction()"><img src="image/top.jpg" width="50px" height="50px"/></button>
<script src="javascript/deleteforumpost_totop.js"></script>
</body>
</html>