...
<title>E-Forum Navigation Bar</title>
</head>
...
<ul class="ul1">
    ...
    <div class="dropdown">
  	<li class="li1 active"><a href="search_alumni.php"><span class="span1">Search Alumni</span></a></li>
    </div>
    <div class="dropdown">
    <li class="li1"><a href="contact_us.php"><span class="span1">Contact Us</span></a></li>
    	<div class="dropdown-content">
    		<a href="contact_us.php#location">Contact</a>
